    ...
    <section className="relative w-full h-screen flex items-center justify-center bg-white">
      ...
      <div className="absolute left-0 top-0 w-full md:w-1/2 h-1/2 md:h-full overflow-hidden group">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center group-hover:text-white transition-colors duration-300 z-10">
          ...
          <Link to="/men" className="mt-6 px-4 sm:px-6 py-2 bg-black text-white font-medium uppercase tracking-wide rounded-lg shadow hover:bg-white hover:text-black transition-all duration-300 hover:shadow-lg text-sm sm:text-base">
            Try Wears
          </Link>
        </div>
      </div>
      ...
      <div className="absolute right-0 bottom-0 md:top-0 w-full md:w-1/2 h-1/2 md:h-full overflow-hidden group">
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-center group-hover:text-white transition-colors duration-300 z-10">
          ...
          <Link to="/women" className="mt-6 px-4 sm:px-6 py-2 bg-red-500 text-white font-medium uppercase tracking-wide rounded-lg shadow hover:bg-white hover:text-black transition-all duration-300 hover:shadow-lg text-sm sm:text-base">
            Try Wears
          </Link>
        </div>
      </div>
