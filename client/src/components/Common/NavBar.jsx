      ...
      <div className="flex justify-between items-center py-3 sm:py-4 px-4 sm:px-6 lg:px-8 bg-transparent">
        ...
        <div className="flex items-center gap-3 sm:gap-4 lg:gap-6 text-[18px] sm:text-[20px]">
          ...
          {user && user.role !== 'admin' && (
            <button onClick={() => setOpen(o => !o)} className="text-black hover:text-gray-700 transition-all duration-300 relative flex items-center bg-white rounded-full p-2 shadow-sm" aria-label="Notifications">
              <HiOutlineBell />
              {unreadCount > 0 && (
