      ...
      <div className="pt-16 h-screen flex flex-col">
        <div className="max-w-5xl mx-auto w-full h-full flex flex-col px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col flex-1 overflow-hidden">
            ...
            <div
              ref={listRef}
              className="flex-1 overflow-y-auto p-6 space-y-4 bg-white scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100"
              ...
              >
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm bg-white focus:bg-white focus:border-gray-400 focus:ring-2 focus:ring-gray-200 transition-all duration-200 placeholder-gray-400 text-gray-900"
                  />
                </div>
                <button 
                  type="submit"
                  className="bg-gray-900 hover:bg-black text-white px-6 py-3 rounded-xl font-medium shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed border border-gray-900"
                  disabled={!text.trim()}
                >
                  Send
                </button>
